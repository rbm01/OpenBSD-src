...
;;;
;;;#ident "@(#)cvs/contrib/pcl-cvs:$Name: not supported by cvs2svn $:$Id: pcl-cvs.el,v 1.1.1.3 1997/02/21 06:38:27 tholo Exp $"
;;;
...
ERR-BUF should be 'STDOUT or 'STDERR."
  ...
  (let* ((stdout (save-excursion (set-buffer stdout-buffer) (buffer-string)))
    ...
    (insert "CVS Version: "
	    "@(#)cvs/contrib/pcl-cvs:$Name: not supported by cvs2svn $:$Id: pcl-cvs.el,v 1.1.1.3 1997/02/21 06:38:27 tholo Exp $\n\n")
