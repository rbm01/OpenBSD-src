...
;;;
;;;#ident "@(#)cvs/contrib/pcl-cvs:$Name: not supported by cvs2svn $:$Id: pcl-cvs.el,v 1.1.1.2 1996/10/18 03:36:26 tholo Exp $"
;;;
...
ERR-BUF should be 'STDOUT or 'STDERR."
  ...
  (let* ((stdout (save-excursion (set-buffer stdout-buffer) (buffer-string)))
    ...
    (insert "CVS Version: "
	    "@(#)cvs/contrib/pcl-cvs:$Name: not supported by cvs2svn $:$Id: pcl-cvs.el,v 1.1.1.2 1996/10/18 03:36:26 tholo Exp $\n\n")
