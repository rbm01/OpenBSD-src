...
;;;
;;;#ident "@(#)cvs/contrib/pcl-cvs:$Name: not supported by cvs2svn $:$Id: pcl-cvs.el,v 1.1.1.2 1996/01/30 00:19:09 tholo Exp $"
;;;
;;; pcl-cvs.el -- A Front-end to CVS 1.3 or later.
;;; Release 1.05-CVS-$Name: not supported by cvs2svn $.
...
(defconst pcl-cvs-version "1.05-CVS-$Name: not supported by cvs2svn $"
...
(defconst cvs-startup-message
  (if cvs-inhibit-copyright-message
      "PCL-CVS release 1.05-CVS-$Name: not supported by cvs2svn $"
    "PCL-CVS release 1.05 from CVS release $Name: not supported by cvs2svn $.
...
This description is updated for release 1.05-CVS-$Name: not supported by cvs2svn $ of pcl-cvs.
...
ERR-BUF should be 'STDOUT or 'STDERR."
  ...
  (let* ((stdout (save-excursion (set-buffer stdout-buffer) (buffer-string)))
    ...
    (insert "CVS Version: "
	    "@(#)cvs/contrib/pcl-cvs:$Name: not supported by cvs2svn $:$Id: pcl-cvs.el,v 1.1.1.2 1996/01/30 00:19:09 tholo Exp $\n\n")
