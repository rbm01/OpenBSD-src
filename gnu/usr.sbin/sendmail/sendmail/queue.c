...
#ifndef lint
# if QUEUE
static char id[] = "@(#)$Id: queue.c,v 1.1.1.2 2001/01/15 20:52:16 millert Exp $ (with queueing)";
# else /* QUEUE */
static char id[] = "@(#)$Id: queue.c,v 1.1.1.2 2001/01/15 20:52:16 millert Exp $ (without queueing)";
# endif /* QUEUE */
#endif /* ! lint */
