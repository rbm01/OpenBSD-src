...
#ifndef lint
# ifdef DAEMON
static char id[] = "@(#)$Id: daemon.c,v 1.1.1.2 2001/01/15 20:52:13 millert Exp $ (with daemon mode)";
# else /* DAEMON */
static char id[] = "@(#)$Id: daemon.c,v 1.1.1.2 2001/01/15 20:52:13 millert Exp $ (without daemon mode)";
# endif /* DAEMON */
#endif /* ! lint */
