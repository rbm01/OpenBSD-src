...
#ifndef lint
# if SMTP
static char id[] = "@(#)$Id: srvrsmtp.c,v 1.1.1.2 2001/01/15 20:52:18 millert Exp $ (with SMTP)";
# else /* SMTP */
static char id[] = "@(#)$Id: srvrsmtp.c,v 1.1.1.2 2001/01/15 20:52:18 millert Exp $ (without SMTP)";
# endif /* SMTP */
#endif /* ! lint */
